...
def redrawAll(app, canvas):
    if app.mode == 'week':
        textColor = 'black'
        bgColor = 'blanchedAlmond' #rgbString(350, 300, 600)
        ...
        canvas.create_oval(cx2-r2, cy2-r2, cx2+r2, cy2+r2, fill='black')
        firstTextY = 100
